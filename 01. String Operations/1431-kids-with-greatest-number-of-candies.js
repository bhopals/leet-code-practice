...
var kidsWithCandies = function (candies, extraCandies) {
  ...
  //candies.forEach(elem => elem+extraCandies >= maxCandies ?  )
  // // Get Max Candies Count
  ...
  // Fill in Result arr;
  for (let i = 0; i < candies.length; i++) {
    resultArr[i] = candies[i] + extraCandies >= maxCandies;
  }
...
function kidsWithCandies(candies, extraCandies) {
  ...
  // Initialize the result array with the length of candies array
